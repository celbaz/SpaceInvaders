(function () {
  ...
  Game.prototype.draw = function (ctx) {
    ...
    ctx.fillText("Level: " + this.LEVEL, 680, 30);
    this.drawAll(ctx);
  };
  ...
  Game.prototype.startMenu = function (ctx) {
    ...
    ctx.font = "22px Anonymous Pro";
    ctx.fillStyle = "#f00";
    ctx.fillText("Commands:",  Game.DIM_X/2  - 150, Game.DIM_Y/2 - 100);
    ctx.fillText("Use SpaceBar to fire bullets.",  Game.DIM_X/2  - 150, Game.DIM_Y/2 - 75);
    ctx.fillText("Use Left and Right arrows to move.",  Game.DIM_X/2  - 150, Game.DIM_Y/2 - 50);
    ctx.fillText("Press ENTER To Play", Game.DIM_X/2 - 150, Game.DIM_Y/2);
  };
})();
